"""
Django settings for geodatamanager project.
...
ROOT_URLCONF = "geodatamanager.urls"
...
WSGI_APPLICATION = "geodatamanager.wsgi.application"
...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost",
    "http://127.0.0.1",
] + [f"http://{host}" for host in os.getenv("DJANGO_ALLOWED_HOSTS", "").split(",") if host] 
...
WAGTAILDOCS_EXTENSIONS = ['csv', 'docx', 'key', 'odt', 'pdf', 'pptx', 'rtf', 'txt', 'xlsx', 'zip', 'ipynb']
