...
from weather_station_ingestion.services.text_payload_parser import TextPayloadParserFactory
...
class TextPayloadNormalizationService:
    ...
    def normalize_and_write(
        ...
        *,
        ...
        parser = TextPayloadParserFactory.get_parser(text)
