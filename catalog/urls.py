...
from .views import DatasetAvailabilityView, DatasetVisualizationView, DatasetNotebookView
...
urlpatterns = [
    ...
    path("datasets/<str:dataset_id>/notebook/", DatasetNotebookView.as_view(),
